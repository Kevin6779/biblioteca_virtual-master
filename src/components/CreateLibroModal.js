...
function CreateLibroModal(props){
    ...
    const [diponibilidad, setDiponibilidad] = useState(null);

    useEffect(() => {
        GeneroService.get().then(resp => {
...
switch (name) {
    ...
    case "paginas":
        ...
        break;
    case "disponibilidad":
        setDiponibilidad(value ? value : null);
        break;
    default:
        break;
    }
...
return (
    <Modal backdrop="static" show={show} onHide={handleClose}>
        <Modal.Header closeButton>
            <Modal.Title>Añadir Nuevo Libro</Modal.Title>
        </Modal.Header>
        <Modal.Body>
            <Form>
                <FormGroup>
                ...
                <FormGroup>
                    ...
                    <FormControl
                        name="diponibilidad"
                        onChange={handleOnChange}
                        value={diponibilidad ? diponibilidad : ""} />
                </FormGroup>
            </Form>
        </Modal.Body>
        <Modal.Footer>
